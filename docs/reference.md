...
Разделы тела: «Что нужно сделать», «Почему важно», «Критерии готовности (DoD)», «Пререквизиты», «Пошаговый план», «Вопросы», «Заметки». Семантика каждого — в [methodology.md](methodology.md).
